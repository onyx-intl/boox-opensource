...
private:
    ...
    // John, TODO
    POLE::Storage *m_inputFile;
    POLE::Storage *m_outputFile;
    ...
    union Directory
    {
        Directory( POLE::Storage* in ) : infile( in ) {}
        Directory( POLE::Storage* out, int i = 0 ) : outfile( out ) {}

        POLE::Storage* infile;
        POLE::Storage* outfile;
    };
