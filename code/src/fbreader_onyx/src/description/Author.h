...
inline AuthorPtr SingleAuthor::create(const std::string &displayName, const std::string &sortKey) {
  return AuthorPtr(new SingleAuthor(displayName, sortKey));
}
...
inline AuthorPtr MultiAuthor::create(AuthorPtr author) { return AuthorPtr(new MultiAuthor(author)); }
