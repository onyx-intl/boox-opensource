...
FBMargins::FBMargins() :
	LeftMarginOption(ZLCategoryKey::LOOK_AND_FEEL, OPTIONS, "LeftMargin", 0, 1000, 15),
	RightMarginOption(ZLCategoryKey::LOOK_AND_FEEL, OPTIONS, "RightMargin", 0, 1000, 15),
	TopMarginOption(ZLCategoryKey::LOOK_AND_FEEL, OPTIONS, "TopMargin", 0, 1000, 15),
	BottomMarginOption(ZLCategoryKey::LOOK_AND_FEEL, OPTIONS, "BottomMargin", 0, 1000, 15) {
}
...
FBIndicatorStyle& FBView::commonIndicatorInfo() {
	if (!ourIndicatorInfo) {
          ourIndicatorInfo.reset(new FBIndicatorStyle());
	}
