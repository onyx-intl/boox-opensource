...
ZLTextBaseStyle::ZLTextBaseStyle(const std::string &fontFamily, int fontSize) :
    ...
    SelectionBackgroundColorOption(ZLCategoryKey::LOOK_AND_FEEL, COLORS, "SelectionBackground", ZLColor(255, 255, 255)),
    SelectedTextColorOption(ZLCategoryKey::LOOK_AND_FEEL, COLORS, "SelectedText", ZLColor(255, 255, 255)),
    ...
    myHyperlinkColorOptions["external"] =
        shared_ptr<ZLColorOption>(new ZLColorOption(ZLCategoryKey::LOOK_AND_FEEL, COLORS, "ExternalHyperlink", ZLColor(128, 128, 128)));
    myHyperlinkColorOptions["book"] =
        shared_ptr<ZLColorOption>(new ZLColorOption(ZLCategoryKey::LOOK_AND_FEEL, COLORS, "BookHyperlink", ZLColor(143, 89, 2)));
}
